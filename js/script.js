window.onload = function(){
	...
	require(["../codemirror/lib/codemirror", "../codemirror/mode/htmlmixed/htmlmixed"] ,function(CodeMirror) {
		window.htmleditor = CodeMirror.fromTextArea(document.getElementById("htmlcode"), {
			lineNumbers: true,
			mode: "htmlmixed"
  		});
	});
	require(["../codemirror/lib/codemirror", "../codemirror/mode/css/css"] ,function(CodeMirror) {
  		window.csseditor = CodeMirror.fromTextArea(document.getElementById("csscode"), {
    			lineNumbers: true,
			mode: "css"
		});
	});
	require(["../codemirror/lib/codemirror", "../codemirror/mode/javascript/javascript"] ,function(CodeMirror) {
		window.jseditor = CodeMirror.fromTextArea(document.getElementById("jscode"), {
			lineNumbers: true,
			mode: "javascript"
		});
	});
